...
class GamePlayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_player" do
    assert_difference('GamePlayer.count') do
      post game_players_url, params: { game_player: { end_inning: @game_player.end_inning, game_id: @game_player.game_id, jersey_number: @game_player.jersey_number, player_id: @game_player.player_id, batting_order_position: @game_player.batting_order_position, fielding_position: @game_player.fielding_position, start_inning: @game_player.start_inning } }
    end
  ...
  test "should update game_player" do
    patch game_player_url(@game_player), params: { game_player: { end_inning: @game_player.end_inning, game_id: @game_player.game_id, jersey_number: @game_player.jersey_number, player_id: @game_player.player_id, batting_order_position: @game_player.batting_order_position, fielding_position: @game_player.fielding_position, start_inning: @game_player.start_inning } }
